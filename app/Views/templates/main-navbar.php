<div class="main-top">
    <form class="main-search" method="POST" action="<?= base_url(); ?>">
        <input type="image" name="navSearch" src="<?= base_url('assets/media/svgs/search.svg') ?>" width="20" height="20" value="submit">
        <input type="text" name="navSearchText" placeholder="What do you want to listen to?" class="main-search-text">
    </form>
